...
QT_MOC_LITERAL(1, 6, 16), // "fieldSizeChanged"
QT_MOC_LITERAL(2, 23, 0), // ""
QT_MOC_LITERAL(3, 24, 4), // "size"
QT_MOC_LITERAL(4, 29, 13), // "fieldReplaced"
QT_MOC_LITERAL(5, 43, 11), // "BoardField*"
QT_MOC_LITERAL(6, 55, 9), // "old_field"
QT_MOC_LITERAL(7, 65, 9) // "new_field"

    },
    "Board\0fieldSizeChanged\0\0size\0fieldReplaced\0"
    "BoardField*\0old_field\0new_field"
};
...
void Board::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->fieldSizeChanged((*reinterpret_cast< const QPoint(*)>(_a[1]))); break;
        case 1: _t->fieldReplaced((*reinterpret_cast< BoardField*(*)>(_a[1])),(*reinterpret_cast< BoardField*(*)>(_a[2]))); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Board::fieldSizeChanged)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (Board::*_t)(BoardField * , BoardField * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Board::fieldReplaced)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void Board::fieldSizeChanged(const QPoint & _t1)
{
...
// SIGNAL 1
void Board::fieldReplaced(BoardField * _t1, BoardField * _t2)
{
